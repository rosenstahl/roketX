                  ...
                  <div className="bg-white rounded-2xl shadow-sm p-12">
                    <div className="space-y-8">
                      ...
                      <div className="flex flex-col gap-6">
                        <div className="flex justify-between items-start">
                          <div className="space-y-1">
                            ...
                            <p className="text-main-tertiary">
                        ...
                        {testimonial.award && (
                          <div className="inline-flex items-center gap-2 bg-accent-primary/5 px-4 py-2 rounded-full">
                            ...
                            <span className="text-sm font-['SF_Pro_Display'] font-medium text-accent-primary">
                              {testimonial.award}
                            </span>
                          </div>
                        )}
                      ...
                      <div className="relative">
                        ...
                        <p className="text-main-tertiary leading-relaxed text-lg font-['Inter'] italic">
                          {testimonial.content}
                        </p>
                      </div>
                    </div>
