...
// Updated ContactLink with white text
...
// Updated LegalLink with increased spacing
const LegalLink = ({ to, children }) => (
  <motion.div
    whileHover="hover"
    initial="initial"
    className="mt-6" // Increased spacing
  >
    <Link 
      to={to} 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10">
            ...
            >
              ...
              <FooterText className="text-white/80">
                Wir entwickeln Ihre Vision zum marktreifen Unternehmen - 
                von der Konzeption bis zur erfolgreichen Markteinführung.
              </FooterText>
            </motion.div>

            {/* Kontakt with increased spacing */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.1 }}
            >
              <FooterHeading className="text-white font-sf text-xl font-semibold mb-8">Kontakt</FooterHeading>
            ...
            {/* Rechtliches with increased spacing */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <FooterHeading className="text-white font-sf text-xl font-semibold mb-8">Rechtliches</FooterHeading>
              <nav>
                <LegalLink to="/impressum">Impressum</LegalLink>
                <LegalLink to="/agb">AGB</LegalLink>
                <LegalLink to="/datenschutz">Datenschutz</LegalLink>
              </nav>
            </motion.div>

            {/* CTA with loading orange hover effect */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.3 }}
            >
              <FooterHeading className="text-white font-sf text-xl font-semibold">Kontaktieren Sie uns</FooterHeading>
